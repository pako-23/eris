...
for exp_n in $(seq 1 1); do
    ...
    for scaling_dp in $(seq 1 1); do
        ...
        for fold in $(seq 2 $k_folds); do
            ...
            pkill -u dario -9 -f coordinator.py
            pkill -9 -f client_eris.py
            pkill -u dario -9 -f client_eris.py
            pkill -9 -f coordinator.py
            pkill -u dario -9 -f coordinator.py
            pkill -9 -f client_eris.py
            pkill -u dario -9 -f client_eris.py
