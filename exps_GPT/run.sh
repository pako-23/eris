...
for n_samples in "${client_training_samples[@]}"; do
    ...
    for fold in $(seq 0 $((n_folds - 1))); do
        ...
        python local_fl_training.py --model_name $model_name --n_clients $n_clients --client_training_samples $n_samples --fold $fold --fl_rounds $fl_rounds --fold $fold --output_dir $output_dir --local_epochs $local_epochs
