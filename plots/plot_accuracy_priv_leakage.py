...
dataset_imdb = {
    'Shatter': {  
        'accuracy':      [0.66617, 0.75114, 0.78704, 0.800264, 0.81364, 0.8172],
        'accuracy_std':  [0.02976280229, 0.0098769226, 0.00460295557, 0.00304152593, 0.00292793443, 0.00188874443] / np.sqrt(5),
        'priv_leak':     [0.690666667, 0.6432, 0.55808, 0.546681905, 0.537309767, 0.520849412],
        'priv_leak_std': [0.038087618, 0.027527441, 0.020775553, 0.007414457, 0.017052052, 0.011184472] / np.sqrt(5)
    },
    'ERIS': {  # compression 2000 
        'accuracy':      [0.678312, 0.769136, 0.793752, 0.799168, 0.807344, 0.81152, 0.816536],
        'accuracy_std':  [0.049142987, 0.010037326, 0.012337115, 0.003314685, 0.001627287, 0.006345367, 0.002932368]/ np.sqrt(5),
        'priv_leak':     [0.682453333, 0.618688, 0.545978182, 0.54023619, 0.540301395, 0.518825412, 0.513069708],
        'priv_leak_std': [0.050962337, 0.025282511, 0.024087659, 0.006144676, 0.016307247, 0.011586023, 0.004873402]/ np.sqrt(5)
    },
    'FedAvg': {
        'accuracy':      [0.669096, 0.779912, 0.795064, 0.809704, 0.815152, 0.817472, 0.82764],
...
dataset_mnist = {
    'Shatter': {   
        'accuracy':      [0.1488236, 0.1625028, 0.2966776, 0.4347536, 0.5588748, 0.7237508],
        'accuracy_std':  [0.05336046535, 0.0445173166, 0.197052662, 0.1346496385, 0.1473464031, 0.1783605694] / np.sqrt(5),
        'priv_leak':     [0.682746667, 0.549472, 0.552589091, 0.523226667, 0.515471628, 0.514849882],
        'priv_leak_std': [0.036972696, 0.015912127, 0.016326558, 0.009302898, 0.005612337, 0.007169844] / np.sqrt(5)
    },
    'ERIS': {  # compression 3
        'accuracy':      [0.81446, 0.86516, 0.89256, 0.9221, 0.94726, 0.96822, 0.97444],
        'accuracy_std':  [0.01685771, 0.01000192, 0.006573462, 0.003414674, 0.0021077, 0.002003397, 0.002006589] / np.sqrt(5),
...
dataset_cifar = {
    'Shatter': {  
        'accuracy':      [0.11459, 0.1135952, 0.1259916, 0.1354124, 0.1497192, 0.1951256],
        'accuracy_std':  [0.01453938809, 0.01786831299, 0.01741568445, 0.02156781145, 0.01456428018, 0.02030401484] / np.sqrt(5),
        'priv_leak':     [0.870702585, 0.829456, 0.814472727, 0.792586267, 0.751847442, 0.734665412],
        'priv_leak_std': [0.042460687, 0.022192606, 0.0104308, 0.009920529, 0.01177371, 0.007824994] / np.sqrt(5)
    },
    # 'ERIS': {  # No compression
    #     'accuracy':      [0.27628, 0.32726, 0.35812, 0.42564, 0.46086, 0.49882, 0.56512],
    #     'accuracy_std':  [0.005898949, 0.009133148, 0.006745191, 0.009270297, 0.004608948, 0.007149378, 0.003091537] / np.sqrt(5),
...
#     'PriPrune (p=0.1)': mcolors.to_rgba('tab:purple', alpha=0.5),
