...
# This script is used to run the federated learning experiments for the FedAvg framework (with LLMs). 
# Based on the config file, it can be used to run Pruning-based FL, Local Differential Privacy-based FL.
